function RegainingWillpower() {
    return (
        <div className="fadeIn">
            ...
            <h3>Each Night</h3>
            <p>Characters regain one Willpower point each night when they first rise.</p>
            ...
            <p>For example, if a Rebel character rabidly opposes a powerful elder, and that elder is later revealed to be a Sabbat spy, that character may be given a point of Willpower.</p>
...
export default RegainingWillpower;